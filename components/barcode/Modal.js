...
export default class Overlay extends Component {
  ...
  calculateDiscount = discountPercentageOff => {
    ...
    if (regularPrice > 0) {
      ...
      onChangeText("discountedPrice", discountedPrice);
    }
  };
  ...
  onNumberPress = type => {
    ...
    onChangeText("discountPercentageOff", discountPercentageOff);
  ...
  render() {
    ...
    return (
      <>
        ...
        <Text style={styles.header}>Adding a product</Text>
        ...
        <View style={styles.box}>
          <View style={styles.left2}>
            <Text style={styles.inputHeader}>Percentage off</Text>
          ...
          <View style={styles.right2}>
            <Text style={styles.inputHeader}>Discounted price</Text>
